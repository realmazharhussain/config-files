    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="col-md-4">
		 ...
		 <div class="col-md-5">
		<a href="http://yugeshverma.blogspot.in" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Mazhar Hussain</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+92 9165063741</h4>
		<h4 style="font-family:'typo' ">mhk@mhk.com</h4>
		<h4 style="font-family:'typo' ">BZU, Multan</h4></div></div>
		</p>
      </div>
